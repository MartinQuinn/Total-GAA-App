...
public class MyCursorCountyAdapter extends CursorAdapter{
    public MyCursorCountyAdapter(Context context, Cursor cursor) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.county_row, parent, false);
    }
